  ...
  return (
    <div className="text-center shadow-sm rounded">
      <ul className="list-group ">
        ...
        <li className= {bmi<18.5 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
        ...
        <li className= {bmi > 18.5 && bmi < 24.9 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
        ...
        <li className={bmi > 25 && bmi < 29.9 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
        ...
        <li className={bmi > 30 && bmi < 34.9 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
        ...
        <li className={bmi > 35 && bmi < 39.9 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
        ...
        <li className={bmi>40 ? "border border-danger border-3" : "list-group-item"}>
          <div className="row">
